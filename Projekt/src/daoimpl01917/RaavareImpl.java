...
public class RaavareImpl implements RaavareDAO {
	...
	public List<RaavareDTO> getRaavareList() throws DALException {
		...
		try{
			while(rs.next()){
				list.add(new RaavareDTO(rs.getInt("raavareId"), rs.getString("raavareNavn"), rs.getString("leverandoer")));
			}
		}
		catch (SQLException e) {throw new DALException(e);}
		return list;
	...
	public void createRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate("INSERT INTO raavare(raavareId, raavareNavn, leverandoer) VALUES (" 
	...
	public void updateRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate("UPDATE raavare SET raavareNavn = '" + raavare.getRaavareNavn() 
							+ "', leverandoer =  '" + raavare.getLeverandoer() + "' WHERE raavareId = " 
